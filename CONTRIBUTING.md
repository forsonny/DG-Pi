...
If you use an agent, run it from the `dg-pi` root directory so it picks up `AGENTS.md` automatically. Your agent must follow the rules and guidelines in that file.
...
Open an [issue](https://github.com/forsonny/DG-Pi/issues).

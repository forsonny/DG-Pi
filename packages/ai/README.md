...
```bash
npm install @dg-forsonny/dg-pi-ai
```

TypeBox exports are re-exported from `@dg-forsonny/dg-pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { getModel, stream } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { Model, stream } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { getModel, complete, Context } from '@dg-forsonny/dg-pi-ai';
...
```typescript
import { Context, getModel, complete } from '@dg-forsonny/dg-pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@dg-forsonny/dg-pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@dg-forsonny/dg-pi-ai';
...
```bash
npx @dg-forsonny/dg-pi-ai login              # interactive provider selection
npx @dg-forsonny/dg-pi-ai login anthropic    # login to specific provider
npx @dg-forsonny/dg-pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@dg-forsonny/dg-pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@dg-forsonny/dg-pi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@dg-forsonny/dg-pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@dg-forsonny/dg-pi-ai';
import { getOAuthApiKey } from '@dg-forsonny/dg-pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@dg-forsonny/dg-pi-ai`

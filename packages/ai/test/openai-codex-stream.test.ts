...
const originalAgentDir = process.env.DG_PI_CODING_AGENT_DIR;

afterEach(() => {
	global.fetch = originalFetch;
	if (originalAgentDir === undefined) {
		delete process.env.DG_PI_CODING_AGENT_DIR;
	} else {
		process.env.DG_PI_CODING_AGENT_DIR = originalAgentDir;
	}
	vi.restoreAllMocks();
});
...
describe("openai-codex streaming", () => {
	it("streams SSE responses into AssistantMessageEventStream", async () => {
		...
		process.env.DG_PI_CODING_AGENT_DIR = tempDir;

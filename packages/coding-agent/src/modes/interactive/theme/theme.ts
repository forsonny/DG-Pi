...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@dg-forsonny/dg-pi-tui";
...
const THEME_KEY = Symbol.for("@dg-forsonny/dg-pi-coding-agent:theme");
...
export function getSettingsListTheme(): import("@dg-forsonny/dg-pi-tui").SettingsListTheme {
	return {

...
import { Agent, type AgentMessage, type ThinkingLevel } from "@dg-forsonny/dg-pi-agent-core";
import type { Message, Model } from "@dg-forsonny/dg-pi-ai";
...
export interface CreateAgentSessionOptions {
	...
	cwd?: string;
	/** Global config directory. Default: ~/.dg-pi/agent */
	agentDir?: string;

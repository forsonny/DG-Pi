 ...
 * Encodes cwd into a safe directory name under ~/.dg-pi/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.dg-pi/agent/sessions/<encoded-cwd>/).
	 */

...
import { createAgentSession, DefaultResourceLoader, SessionManager } from "@dg-forsonny/dg-pi-coding-agent";

// Option 1: Replace prompt entirely
const loader1 = new DefaultResourceLoader({
	systemPromptOverride: () => `You are a helpful assistant that speaks like a pirate.
Always end responses with "Arrr!"`,
	// Needed to avoid DefaultResourceLoader appending APPEND_SYSTEM.md from ~/.dg-pi/agent or <cwd>/.pi.

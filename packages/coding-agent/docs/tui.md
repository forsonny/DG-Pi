...
**Source:** [`@dg-forsonny/dg-pi-tui`](https://github.com/forsonny/DG-Pi/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@dg-forsonny/dg-pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@dg-forsonny/dg-pi-tui";
...
Import from `@dg-forsonny/dg-pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@dg-forsonny/dg-pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@dg-forsonny/dg-pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@dg-forsonny/dg-pi-tui";
...
```typescript
import { getMarkdownTheme } from "@dg-forsonny/dg-pi-coding-agent";
import { Markdown } from "@dg-forsonny/dg-pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@dg-forsonny/dg-pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@dg-forsonny/dg-pi-coding-agent";
import { DynamicBorder } from "@dg-forsonny/dg-pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@dg-forsonny/dg-pi-tui";
...
```typescript
import { BorderedLoader } from "@dg-forsonny/dg-pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@dg-forsonny/dg-pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@dg-forsonny/dg-pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@dg-forsonny/dg-pi-tui";
...
import { matchesKey, truncateToWidth } from "@dg-forsonny/dg-pi-tui";

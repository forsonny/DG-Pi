...
> **Placement for /reload:** Put extensions in `~/.dg-pi/agent/extensions/` (global) or `.pi/extensions/` (project-local) for auto-discovery. Use `pi -e ./path.ts` only for quick tests. Extensions in auto-discovered locations can be hot-reloaded with `/reload`.
...
Create `~/.dg-pi/agent/extensions/my-extension.ts`:
...
| Location | Scope |
|----------|-------|
| `~/.dg-pi/agent/extensions/*.ts` | Global (all projects) |
| `~/.dg-pi/agent/extensions/*/index.ts` | Global (subdirectory) |
...
| Package | Purpose |
|---------|---------|
| `@dg-forsonny/dg-pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `@sinclair/typebox` | Schema definitions for tool parameters |
| `@dg-forsonny/dg-pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@dg-forsonny/dg-pi-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@dg-forsonny/dg-pi-coding-agent";
...
```typescript
import { isBashToolResult } from "@dg-forsonny/dg-pi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@dg-forsonny/dg-pi-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@dg-forsonny/dg-pi-tui";
...
```typescript
import { withFileMutationQueue } from "@dg-forsonny/dg-pi-coding-agent";
...
**Important:** Use `StringEnum` from `@dg-forsonny/dg-pi-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
- [read.ts](https://github.com/forsonny/DG-Pi/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/forsonny/DG-Pi/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/forsonny/DG-Pi/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/forsonny/DG-Pi/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/forsonny/DG-Pi/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/forsonny/DG-Pi/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/forsonny/DG-Pi/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@dg-forsonny/dg-pi-coding-agent";
...
```typescript
import { createBashTool } from "@dg-forsonny/dg-pi-coding-agent";
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/forsonny/DG-Pi/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how tool rows are composed.
...
```typescript
import { keyHint } from "@dg-forsonny/dg-pi-coding-agent";
...
```typescript
import { Text, Component } from "@dg-forsonny/dg-pi-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@dg-forsonny/dg-pi-coding-agent";
import { matchesKey } from "@dg-forsonny/dg-pi-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@dg-forsonny/dg-pi-coding-agent";

...
All keyboard shortcuts can be customized via `~/.dg-pi/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.dg-pi/agent/keybindings.json`:

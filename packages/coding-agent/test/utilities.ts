...
import { getModel, type OAuthCredentials, type OAuthProvider } from "@dg-forsonny/dg-pi-ai";
...
// ============================================================================
// OAuth API key resolution from ~/.dg-pi/agent/auth.json
// ============================================================================
...
/**
 * Resolve API key for a provider from ~/.dg-pi/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.dg-pi/agent/auth.json
 */
...
/**
 * Get an AuthStorage instance backed by ~/.dg-pi/agent/auth.json

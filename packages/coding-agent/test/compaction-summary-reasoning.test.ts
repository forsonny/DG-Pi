...
import type { AssistantMessage, Model } from "@dg-forsonny/dg-pi-ai";
...
vi.mock("@dg-forsonny/dg-pi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@dg-forsonny/dg-pi-ai")>();
	return {
		...actual,

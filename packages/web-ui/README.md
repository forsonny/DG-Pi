# @dg-forsonny/dg-pi-web-ui

Reusable web UI components for building AI chat interfaces powered by [@dg-forsonny/dg-pi-ai](../ai) and [@dg-forsonny/dg-pi-agent-core](../agent).
...
```bash
npm install @dg-forsonny/dg-pi-web-ui @dg-forsonny/dg-pi-agent-core @dg-forsonny/dg-pi-ai
```
...
```typescript
import { Agent } from '@dg-forsonny/dg-pi-agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@dg-forsonny/dg-pi-web-ui';
import '@dg-forsonny/dg-pi-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { SessionListDialog } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { ModelSelector } from '@dg-forsonny/dg-pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@dg-forsonny/dg-pi-web-ui';

# @dg-forsonny/dg-pi-agent-core

Stateful agent with tool execution and event streaming. Built on `@dg-forsonny/dg-pi-ai`.

## Installation

```bash
npm install @dg-forsonny/dg-pi-agent-core
```
...
```typescript
import { Agent, streamProxy } from "@dg-forsonny/dg-pi-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@dg-forsonny/dg-pi-agent-core";

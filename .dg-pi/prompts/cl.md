...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/forsonny/DG-Pi/issues/123))`
- External: `Added bar ([#456](https://github.com/forsonny/DG-Pi/pull/456) by [@user](https://github.com/user))`
